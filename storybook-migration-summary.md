...
- `npx storybook@latest automigrate --config-dir libs/web/ui/common/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir libs/web/ui/layout/.storybook --renderer @storybook/react`
